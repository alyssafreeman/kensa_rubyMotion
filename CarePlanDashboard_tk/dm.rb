...
class Dm
    ...
    def get_config
        ...
        # @http.output_file_name = @config.output_file_name unless @config.output_file_name.nil? #Set the info needed for authentication.
        # @http.source_folder = @config.source_folder unless @config.source_folder.nil?  #HTTP class can decrypt password if you set password_encrypted.
